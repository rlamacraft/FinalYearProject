...
var _user$project$ParsingHandling$buildStatementTree = function (parsedStatementsJson) {
	...
	if (_p2.ctor === 'Err') {
		return _elm_lang$core$Result$Err(
			A2(_elm_lang$core$Basics_ops['++'], 'Could not decode JSON string from parser: ', _p2._0));
	} else {
		return _elm_lang$core$Result$Ok(_p2._0);
	}
};

var _user$project$PresenterMessages$Received = function (a) {
...
var _user$project$Presenter$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_user$project$Renderer$render(model.data));
};
var _user$project$Presenter$update = F2(
	function (msg, model) {
		var _p0 = msg;
...
var _user$project$Presenter$parsedData = _elm_lang$core$Native_Platform.incomingPort('parsedData', _elm_lang$core$Json_Decode$string);
var _user$project$Presenter$subscriptions = function (model) {
	return _user$project$Presenter$parsedData(_user$project$PresenterMessages$Received);
};
var _user$project$Presenter$Model = function (a) {
	return {data: a};
};
var _user$project$Presenter$init = {
	ctor: '_Tuple2',
	_0: _user$project$Presenter$Model(
		_elm_lang$core$Native_List.fromArray(
			[])),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Presenter$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Presenter$init, view: _user$project$Presenter$view, update: _user$project$Presenter$update, subscriptions: _user$project$Presenter$subscriptions})
};

var Elm = {};
Elm['Presenter'] = Elm['Presenter'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Presenter'], 'Presenter', typeof _user$project$Presenter$main === 'undefined' ? null : _user$project$Presenter$main);
