...
var _user$project$Statement$isACommand = function (statement) {
	var _p0 = statement;
...
var _user$project$Statement$hasNoCommandChildren = function (statement) {
	var _p1 = statement;
	if (_p1.ctor === 'StringStatement') {
		return true;
	} else {
		return _elm_lang$core$Basics$not(
			A2(_elm_lang$core$List$any, _user$project$Statement$isACommand, _p1._1));
	}
};
var _user$project$Statement$isRenderableCommand = function (statement) {
	var _p2 = statement;
	if (_p2.ctor === 'StringStatement') {
		return false;
	} else {
		var _p3 = _p2._0;
		if (_p3 === 'hidden') {
...
var _user$project$Statement$leafCommandCount = function (statement) {
	if (_user$project$Statement$isRenderableCommand(statement)) {
		var _p4 = statement;
		if (_p4.ctor === 'Command') {
			return _user$project$Statement$hasNoCommandChildren(statement) ? 1 : _elm_lang$core$List$sum(
				A2(_elm_lang$core$List$map, _user$project$Statement$leafCommandCount, _p4._1));
		} else {
			return 0;
		}
	} else {
...
var _user$project$Statement$StringStatement = function (a) {
	return {ctor: 'StringStatement', _0: a};
};
var _user$project$Statement$Command = F3(
	function (a, b, c) {
		return {ctor: 'Command', _0: a, _1: b, _2: c};
	});

var _user$project$Editor$savedToast = function (state) {
	var html = F2(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(_elm_lang$core$Basics_ops['++'], 'toast toast-', stateClass))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
	...
	var _p0 = state;
	if (_p0.ctor === 'Hidden') {
		return A2(html, 'hidden', _p0._0);
	} else {
		return A2(html, 'showing', _p0._0);
	}
};
...
var _user$project$Editor$saveFile = _elm_lang$core$Native_Platform.incomingPort(
	...
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$Editor$savedFile = _elm_lang$core$Native_Platform.incomingPort('savedFile', _elm_lang$core$Json_Decode$string);
var _user$project$Editor$hideSavedToast = _elm_lang$core$Native_Platform.incomingPort(
	'hideSavedToast',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$Editor$Model = F3(
	function (a, b, c) {
		return {data: a, text: b, savedToast: c};
	});
var _user$project$Editor$Displaying = function (a) {
	return {ctor: 'Displaying', _0: a};
};
var _user$project$Editor$Hidden = function (a) {
...
var _user$project$Editor$init = {
	...
	_0: A3(
		...
		_elm_lang$core$Native_List.fromArray(
			[]),
		'',
		_user$project$Editor$Hidden('')),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Editor$update = F2(
	function (msg, model) {
		var hideSavedToastModel = F2(
			function (toastState, newModel) {
				var _p1 = toastState;
				if (_p1.ctor === 'Hidden') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							newModel,
							{
								savedToast: _user$project$Editor$Hidden(_p1._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
		...
		switch (_p2.ctor) {
			...
			case 'SavedFileStatus':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							savedToast: _user$project$Editor$Displaying(_p2._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return A2(hideSavedToastModel, model.savedToast, model);
		}
	});
var _user$project$Editor$HideSavedToast = {ctor: 'HideSavedToast'};
var _user$project$Editor$SavedFileStatus = function (a) {
	return {ctor: 'SavedFileStatus', _0: a};
};
...
var _user$project$Editor$subscriptions = function (model) {
	var hideSavedToastFunc = function (_p3) {
		var _p4 = _p3;
		return _user$project$Editor$HideSavedToast;
	};
	var saveFileFunc = function (_p5) {
		var _p6 = _p5;
		return _user$project$Editor$SaveFile;
	};
	var parseTextFunc = function (_p7) {
		var _p8 = _p7;
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Editor$savedFile(_user$project$Editor$SavedFileStatus),
				_user$project$Editor$hideSavedToast(hideSavedToastFunc)
			]));
};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Editor$ParseText),
								_elm_lang$html$Html_Attributes$class('btnPresent')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Editor$savedToast(model.savedToast)
					]))
			]));
};
